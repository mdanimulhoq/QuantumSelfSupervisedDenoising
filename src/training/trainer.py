...
class N2LNTrainer:
    ...
    def train_epoch(self, train_loader: DataLoader, mode: str = "sn_d_only", epoch: int = 0) -> Dict[str, float]:
        self.model.train()
        total_loss = 0.0
        total_dist = 0.0
        total_phys = 0.0
    ...
    def validate(self, val_loader: DataLoader, mode: str = "sn_only") -> Dict[str, float]:
        self.model.eval()
        total_loss = 0.0
        n_batches = 0
        with torch.no_grad():
